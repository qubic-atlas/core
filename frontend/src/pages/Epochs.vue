  ...
  <div class="panel table-wrap">
    <table>
      <thead><tr>
        ...
        <th>{{ t("pages.epochs.colLast") }}</th><th>{{ t("pages.epochs.colVerified") }}</th>
      </tr></thead>
      <tbody>
        <tr v-if="err"><td colspan="6" class="center">{{ t("common.failed") }}: {{ err }}</td></tr>
        <tr v-else-if="!rows"><td colspan="6" class="center muted"><span class="spin" /> {{ t("common.loading") }}</td></tr>
